...
class InlineKeyboardButton(Object):
    ...
    def __init__(
        ...
        style: "pyrogram.enums.ButtonStyle" = None # Tetap ada agar helper tidak error
    ):
        super().__init__()
        ...
        self.style = style # Simpan saja di memory
    ...
    async def write(self, client: "pyrogram.Client"):
        # KUNCI: Jangan masukkan 'style' ke dalam raw.types
        # agar tidak AttributeError atau TypeError
        ...
        if self.switch_inline_query_current_chat is not None:
            return raw.types.KeyboardButtonSwitchInline(
                text=self.text, query=self.switch_inline_query_current_chat, same_peer=True
            )
